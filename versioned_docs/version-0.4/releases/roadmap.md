...
The 0.4.0 release focuses on developer experience, third-party library support, and denial observability:
...
- ✅ **Mode-aware denial logging**: STRICT denials log at ERROR, AUDIT/PERMISSIVE at WARN
- ✅ **JMX denial counters**: Always-on `io.jguard:type=DenialCounters` MBean for monitoring
